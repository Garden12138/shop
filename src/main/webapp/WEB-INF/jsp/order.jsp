			...
			<div class="cart_table">
									...
									<tbody>
										<tr>
											...
											<td align="left" valign="middle"><input
												...
												type="text" value="${session_user.name}">&nbsp;</td>
										</tr>
										<tr>
											...
											<td align="left" valign="middle"><span
												...
												<input id="consignee_address" class="txt" maxlength="50"
													type="text" value="${session_user.address}" 
										...
										<tr>
											...
											<td align="left" valign="middle"><input
												id="consignee_message" class="txt" type="text" value="${session_user.phone}">
										...
										<tr>
											...
											<td align="left" valign="middle"><input
												id="consignee_email" class="txt" type="text" value="${session_user.email}"> &nbsp;
				...
				<div id="part_cart">
					<div class="o_show">
						<h1>
							...
							<a href="ShowShopCarItem.action" style="color: rgb(0, 112, 215);">返回修改购物车</a>
						</h1>
						<div class="middle">
				...
				<div id="ware_info">
					...
					<div class="middle">
						<!--订单信息-->
						<ul id="part_info">
							<li class="info1" style="padding-bottom: 5px">商品金额：<fmt:formatNumber value="${totalMoney}" pattern="0.00"></fmt:formatNumber> 元 +
									...
									<tbody>
										<tr>
											...
											<td style="text-align: right; font-size: 15px;"><b>应付总额：<font
													color="red">￥<fmt:formatNumber value="${totalMoney}" pattern="0.00"></fmt:formatNumber>  </font> 元
											</b>
